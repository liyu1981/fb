...
service_url_dict = {
    ...
    'slideshows_by_user' : 'https://www.slideshare.net/api/%d/get_slideshows_by_user' % API_VERSION,
    'slideshows_by_group' : 'https://www.slideshare.net/api/%d/get_slideshows_by_group' % API_VERSION,
...
class pyslideshare:
    ...
    ##############################
    def get_slideshows_by_user(self, username_for=None,offset=None,limit=None):
        """
        ...
        return self.make_call('slideshows_by_user', username_for=username_for, offset=offset, limit=limit)
    ...
    def get_slideshows_by_tag(self, tag=None, offset=None, limit=None):
        """
        ...
        if not tag:
            ...
            sys.exit(1)
        return self.make_call('slideshows_by_tag', tag=tag, offset=offset, limit=limit)

    def get_slideshows_by_group(self, group_name=None, offset=None, limit=None):
        """
        ...
        if not group_name:
            ...
            sys.exit(1)
        return self.make_call('slideshows_by_group', group_name=group_name, offset=offset, limit=limit)
